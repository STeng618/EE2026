...
//        if ( en && ( r_1 < 63 ) && ( r_2 < 63 ) && ( r_3 < 63 ) && ( r_4 < 63 ) ) begin
        if ( en ) begin        
...
//            if      ( ( ( ( r_1 - 1 ) * ( r_1 - 1 ) ) <= d_1 ) && ( ( ( r_1 + 1 ) * ( r_1 + 1 ) ) >= d_1 ) ) oled_circ = YELLOW;
//            else if ( ( ( ( r_2 - 1 ) * ( r_2 - 1 ) ) <= d_2 ) && ( ( ( r_2 + 1 ) * ( r_2 + 1 ) ) >= d_2 ) ) oled_circ = BLUE;
//            else if ( ( ( ( r_3 - 1 ) * ( r_3 - 1 ) ) <= d_3 ) && ( ( ( r_3 + 1 ) * ( r_3 + 1 ) ) >= d_3 ) ) oled_circ = GREEN;
//            else if ( ( ( ( r_4 - 1 ) * ( r_4 - 1 ) ) <= d_4 ) && ( ( ( r_4 + 1 ) * ( r_4 + 1 ) ) >= d_4 ) ) oled_circ = RED;
        end
